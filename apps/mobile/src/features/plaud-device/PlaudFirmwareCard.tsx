  ...
  return (
    <Card style={{ gap: 12 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
        ...
        <Text style={{ fontFamily: fontFamily.semibold, fontSize: 18, color: colors.ink }}>Coming soon</Text>
      </View>
      <Text style={{ fontFamily: fontFamily.regular, fontSize: 14, lineHeight: 21, color: colors.inkSecondary }}>
